  ...
  return (
    <div>
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        <div className='text-center my-10'>A community textile workshop at Grassi Museum in Leipzig. Every Wednesday from 11-1pm and Fridays from 3pm to 5pm</div>
        ...
        <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
          ...
          <div>
          <h2 className='text-5xl'>The Team</h2>
             <Image src={Laura} alt="team member Laura" className='my-4 h-64 w-auto animate-pulse'></Image>
             <p>Laura from the Friday team</p>
             <Image src={Asya} alt="team member Asya" className='my-4 h-64 w-auto'></Image>
             <p>Asya leads the Wednes team with FIA (Frauen in Arbeit)</p>
